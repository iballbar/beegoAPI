...
func Test_NormalUsage(t *testing.T) {
	var week, _ = datetime.NewWeek(2015, 46)
	if len(week.Days) != 7 {
...
func Test_ErrorThrowing(t *testing.T) {
	...
	var _, errorB = datetime.NewWeek(2015)
	...
	var _, errorC = datetime.NewWeek(2015, 54)
	...
	var _, errorD = datetime.NewWeek(-1, 53)
...
func Test_NextWeek(t *testing.T) {
	...
	var weekA, _ = datetime.NewWeek(2015, 53)
...
func Test_PreviousWeek(t *testing.T) {
	...
	var weekA, _ = datetime.NewWeek(2015, 1)
	...
	var weekB, _ = datetime.NewWeek(2017, 1)
...
func Test_ISOWeek_Compatibility(t *testing.T) {
	var week, _ = datetime.NewWeek(2016, 1)
