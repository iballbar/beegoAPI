...
func TestInTimeSpanEqual(t *testing.T) {
	tt := []struct {
		name   string
		start  string
		end    string
		...
		{name: "Test 2017/01/01 00:00:00 in 2017/01/01 00:00:00 and 2017/01/01 01:00:00", start: "2017-01-01T00:00:00+00:00", end: "2017-01-01T01:00:00+00:00", check: "2017-01-01T00:00:00+00:00", expect: true},
		{name: "Test 2017/01/01 00:00:01 in 2017/01/01 00:00:00 and 2017/01/01 01:00:00", start: "2017-01-01T00:00:00+00:00", end: "2017-01-01T01:00:00+00:00", check: "2017-01-01T00:00:01+00:00", expect: true},
		{name: "Test 2017/01/01 01:00:00 in 2017/01/01 00:00:00 and 2017/01/01 01:00:00", start: "2017-01-01T00:00:00+00:00", end: "2017-01-01T01:00:00+00:00", check: "2017-01-01T01:00:00+00:00", expect: true},
		{name: "Test 2017/01/01 02:00:01 in 2017/01/01 00:00:00 and 2017/01/01 01:00:00", start: "2017-01-01T00:00:00+00:00", end: "2017-01-01T01:00:00+00:00", check: "2017-01-01T02:00:01+00:00", expect: false},
	}
	...
	for _, tc := range tt {
		t.Run(tc.name, func(t *testing.T) {
			...
			result := datetime.InTimeSpanEqual(startTime, endTime, checkTime)
			if result != tc.expect {
				t.Errorf("expected %v got: %v", tc.expect, result)
			}
		})
